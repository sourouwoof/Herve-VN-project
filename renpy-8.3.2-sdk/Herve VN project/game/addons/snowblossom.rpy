...
init python:
    ...
    mylist = ["gui/cloudchamber/cloudchambertray1.png",
            "gui/cloudchamber/cloudchambertray2.png",
            "gui/cloudchamber/cloudchambertray3.png",
            "gui/cloudchamber/cloudchambertray4.png",
            "gui/cloudchamber/cloudchambertray5.png",
            "gui/cloudchamber/cloudchambertray6.png",
            "gui/cloudchamber/cloudchambertray7.png",
            "gui/cloudchamber/cloudchambertray8.png",
            "gui/cloudchamber/cloudchambertray9.png",
            "gui/cloudchamber/cloudchambertray10.png",
            "gui/cloudchamber/cloudchambertray11.png",
            "gui/cloudchamber/cloudchambertray12.png",
            "gui/cloudchamber/cloudchambertray13.png",
            "gui/cloudchamber/cloudchambertray14.png",
            ]
    
    #################################################################
    # Snow particles
    # ----------------
    def Snow(image, max_particles=50, speed=150, wind=100, xborder=(0,100), yborder=(50,400), positiveY=True, **kwargs):
        """
        ...
        """
        return Particles(SnowFactory(image, max_particles, speed, wind, xborder, yborder, positiveY, **kwargs))
    ...
    class SnowFactory(object):
        ...
        """
        def __init__(self, image, max_particles, speed, wind, xborder, yborder, positiveY=True, **kwargs):
            """
        ...
        def create(self, particles, st):
            ...
            """
            rndimage = random.choice(mylist)
            self.image = self.image_init(rndimage)
    ...
    class SnowParticle(object):
        ...
        """
        def __init__(self, image, wind, speed, xborder, yborder, positiveY=True):
            """
