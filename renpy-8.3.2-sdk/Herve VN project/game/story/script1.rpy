label story1:
    ...
    mco "Those mountain roads are so winding. Hopefully I'm nearly arrived."
    mco "But it's not so bad, it's been a long time since I've been in the Alps."
    pause 1
    mco "Ugh, it's making me a little nervous."
    mco "Not like I can go back now, I'm so far from home and the city."
    pause 1
    mco "It's funny... I wanted to go back home at midway, I was so nervous... But then, I got excited again, like when I planned the trip."
    pause 1
    mco "... I wonder how's Hervé."
    pause 2
    mco "Maybe taller, or bigger than his photos?"
    pause 1
    mco "*sigh* Oh geez, I don't know if he will remember that one time I hit on him, on Discord. That was cringe."
    mco "How should I be?"
    pause 1
    ...
    mco "I don't know how many rants of mine he read. But he was always there, and so attentive. He helped me a lot going through college."
    pause 1
    mco "I admire him in some ways. He seems to be doing what he's passionate about... While keeping our Discord server a safe place."
    pause 1
    ...
    "*cling clang badum*"
    mco "?!"
    mco "Something is not right. Talked too fast."
    camera
    play music driving
    ...
    pause 2
    mco "It seems there are no problems, but I'm not too sure whether I should continue driving..."
    pause 1
    ...
    pause 1
    mci "... Maybe I can practice introducing myself to Hervé..."
    mco "Hello... Hervé, it's me,"
    $ player_name = renpy.input("Your name is:", "Sébastien").strip() or "Sébastien"
    mco "You know... [player_name]."
    mci "Why on earth real names always sound more cringe than online names?"
    pause 2
    play sound phone_notification
    "*phone notification*"
    mco "...?"
    ...
    mco "Whyyy. My american accent was the best, I practiced so hard. I did like 3 interviews with them!"
    mco "Fuck, \"{i}more experienced candidates{/i}\" no shit, it's supposed to be an entry job? How am I supposed to get any experience?"
    mco "*long sigh* Aaah..."
    pause 1
    scene black
    ...
    pause 5
    heru "{color=#9e8b53}{size=29}Hi! Hello...?{/size}{/color}"
    pause 1
    mci "I hear a familiar, suave yet shy voice in the distance."
    mco "Zzz... {color=#9e8b53}{size=29}Hi...{/size}{/color}"
    ...
    her "Your snow chains are too big, {color=#9e8b53}{size=29}it will take me some time to remove them and find other ones...{/size}{/color}"
    her eblow "My home is not too far... {color=#9e8b53}{size=29}Maybe I can prepare the diner and take care of the car just after.{/size}{/color}"
    mci "He's mumbling underneath his breath. I'm not sure what he says, I'm quite sleepy, but I'm just glad to not be alone anymore."
    her -eblow eyclosed msad "... {color=#9e8b53}{size=29}I hope I have everything in the garage. I think if we let the car here it wouldn't be a problem, there's not too much traffic now.{/size}{/color}"
    ...
    mci "I remember now."
    mco "It's cozy in here, we're in your living room?"
    ...
    her eblow "I renovated this room to make a guest house for money, {color=#9e8b53}{size=29}but I've never been able to set that up...{/size}{/color}"
    ...
    menu:
        "Why?":
            ...
            mco "Aww, why?"
            her ebsad "Oh uhm."
            her -eyclosed "I found that a little complicated. Advertising isn't my strong suit."
            her "Though, it could help me for my retirement, and to keep the house in shape, for sure."
            mco "That sounds awesome, it would give you a chance to rest at home."
            her eblow eyclosed "I should, I should, {color=#9e8b53}{size=29}I quite like my own company too.{/size}{/color}"
    label continue1:
        hide screen timerFrame
    ...
    "*stomach growl*"
    pause 1
    her -eyclosed -eblow "... And if you're hungry, I have some leftovers."
    mco "... That would be great thanks."
    hide he at middle
    scene houseLounge at tint18 
    with dissolve
    stop sfx1 fadeout 25
    mci "We head forward to the dark room, and we cross a large, quite cluttered place. I can't really see what's in there, except some decorations here and there. We continue forward, to a kitchen."
    ...
    pause 1
    mci "I watch outside, it's really dark."
    pause 1
    ...
    her msad eyclosed "No, I usually sleep quite late at night. {color=#9e8b53}{size=29}I don't need it that much sleep, I'm not a youngster anymore...{/size}{/color}"
    pause 1
    her -msad -eyclosed "Uhm [player_name], I wanted to tell you about tomorrow. I took the next days off for our vacations, expect, I couldn't for tomorrow, I will have to go to work."
    ...
    her mhappy eyclosed eblow "Okay, wonderful!"
    scene houseBedroom at tint18 
    hide he
    with Fade(1,1,1)
    mci "After my diner I felt like resting again. Hervé showed me this bedroom to settle in, this is front of the large lounge."
    mco "Really calm in here. A little colder than the guest room but it's alright."
    mco "*long sigh*"
    pause 1
    mco "What a long day."
    pause 1
    mco "It was easier than expected to talk to Hervé. He's a nice guy to be around."
    mco "A little quirky at times, but it's part of his charm. That's what I always found of him on Discord. A little old fashioned."
    pause 2
    ...
    mco "Oh no! It's just..."
    pause 1
    her eyclosed eblow "... Your sleep must be a bit shifted. Sorry, I won't drag around."
    mco "Mmh yeah."
    ...
    pause 1
    mci "Hervé seems to be collecting samples of snow and making measurements since a short time ago."
    mco "What are you doing, Hervé?"
    her -eblow mhappy "Well, that's not for my personal collection, it's for scientists. I sometimes get contacted by some universities to take samples. And remotely send them the measurements."
    her "{color=#9e8b53}{size=29}Rha! Scholars are a lazier now with the internet. Fortunately they gave me their equipments and they showed me how to do the work.{/size}{/color}"
    mco "Woah that's more interesting than it looks, you should have explained me that first."
    her -eyclosed "Quite a far cry from my job of forest ranger. That's a job retraining I wasn't expecting at my age."
    ...
    pause 1
    mci "I think he cares deeply about his mountains."
    pause 2
    her -eyclosed -msad "{color=#9e8b53}{size=29}That will be it.{/size}{/color} I'm good, we can head back home now."
    ...
    pause 2
    hero hat "H-hey soo...? How was it following me to work?"
    mci "... He breaks this long silence, I was paying attention to the wintry landscape."
    mco "Quite fun actually. I learnt a lot of things with you, for real. You're truly a well of knowledge."
    mco "... {color=#9e8b53}{size=29}Like when you showed me how you tuck your pants in your shoes...{/size}{/color}"
    hero mhappy eyclosed eblow "Well, that's not very esthetic, I admit that. But it's a constant challenge to keep out the cold."
    pause 1
    mci "It's crazy how we never stop joking about each other, it's like very natural. I don't know who started first."
    pause 1
    ...
    hero msad eblow "I'm used to not speaking a lot, it's just that I hope I'm not too boring."
    mco "You're not! I'm not much of a chatterbox either."
    mco "{color=#9e8b53}{size=29}... I find your company quite comforting actually...{/size}{/color}"
    hero -eblow mhappy "Ooh! Well... Thank you..."
    mco "Hehe."
    mci "Geez, I don't know if I'm doing the right thing... That's kinda stupid to flirt with him, I should quit doing that."
    pause 2
    mci "I'm curious about him... He never told that he was living with someone, though this house is so big."
    pause 1
    mco "Say, Hervé what's the story behind your house?"
    pause 1
    hero eblow eyclosed "I could give you a tour when returning home, you wanna?"
    mco "Sure!"
    stop sfx1
    ...
    her eblow "I got it for a pittance, {color=#9e8b53}{size=29}kinda. It was no easy task to restore it.{/size}{/color}"
    pause 1
    ...
    her "I tried alone for some parts like carpentry but for the rest it was sketchy... I ended up asked for help to the neighbors around."
    ...
    her mhappy "A little childhood dream at some point. I'm not totally sure haha. But now I'm living it, I'm more than happy. It's so diverse, every new season come with its set of work. And I feel useful to lots of people around."
    pause 1
    ...
    with Fade(1,0,1) 
    play sfx1 fireplace
    mci "Hervé seemed tired after that. Curiously, it seems this little conversation unsettled him."
    mci "We prefered to sit on the couch and relax."
    mco "Home sweet home~ so warm in here."
    hero eyclosed eblow "You're melting like an icicle, watch out hehe. Don't worry we'll stay here now, no need to go outside."
    pause 1
    hero -eyclosed -eblow "Say, we were talking about jobs. What about you-- you told me you were looking for a job, right?"
    mco "We don't talk about sensitive subjects-- mmh yeah. *sigh* Not much for now unfortunately."
    hero msad "You don't have to talk about that if you don't want to..."
    mci "Arh... I kinda want to now. He's so easy to talk to."
    pause 1
    mco "Well. Y'know I got my diploma a couple months ago. Though, I haven't told you, but my university is part of a program helping fresh graduates to find a job abroad."
    mco "I signed up, it looked so compelling. They pay us the plane ticket and rent. I never got the chance to go abroad..."
    mco "But I'm nearly at the end of this program, I only have a week left to find a job abroad... It's a lot more harder than I expected."
    pause 1
    hero eblow "Oh..."
    ...
    hero eyclosed mhappy "First, that's really kind of you to say such nice things about me, you're a great friend for me too."
    pause 1
    hero msad "I have to say, it wasn't easy for me, inviting you here. I almost wanted to cancel our meeting, but that would have been so rude of me."
    mco "Ooh?"
    ...
    pause 1
    mco "B-but you're so chill and caring in the Discord server and all. I see you as someone quite socially active, for real."
    ...
    her mhappy -eblow "Well, nothing better than a hot drink in a wintry day."
    mco "I don't see you as an ermit, you're always full of nice little attentions."
    her -mhappy "Well when I was young, I was in more groups of friends. {color=#9e8b53}{size=29}Though it was never me the first to go to parties.{/color}{/size} That was my boyfriends who made me go out."
    ...
    menu:
        "Do you miss that?":
            ...
            mco "..."
            mco "{color=#9e8b53}{size=29}Though, I think you're pretty handsome.{/size}{/color}"
            her mhappy eblow eyclosed "Rrh shush shush. No flirting. You're too young, you're still a baby to me."
            her -eblow "{color=#9e8b53}{size=29}Our age gap is so wide, it just gives me wrinkles thinking about it...{/size}{/color}"
            mco "Owww..."
    label continue2:
        hide screen timerFrame

    pause 2
    mco "Mmh... I'm curious, you said that you were quite socially active before, but now you don't."
    mco "Was it coming to the mountains that made you like this?"
    her -eyclosed mnormal -eblow "For a good part... {color=#9e8b53}{size=29}I've never seen it that way before.{/size}{/color}"
    her "I've always been the shy one with my friends, so I think it was always part of me."
    mci "I feel that he's avoiding again to tell me the reason why he landed here, I'm not going to push any further."
    her msad eblow "--But I rather think, it's once you grow older it becomes harder to have social interactions."
    mco "Why?"
    her -eblow "... Mmh. There's less opportunities to make friends. People of my age already have their friends."
    her "I've never been able to connect deeply with the people around here."
    her eyclosed eblow "{color=#9e8b53}{size=29}... Urrh for the romance part of things, most of the gays are bi dads in heat, that's terrible.{/size}{/color}"
    pause 1
    mco "Oh~ so you had some adventures in the Alps?"
    her -eyclosed "Over the last 20 years...? Just two, with old men in retirement. It's either that or rare youngsters here. Past a certain age, people go to the city."
    mci "Damn!"
    ...
    mco "Oow, that's sad Hervé!"
    her mhappy eyclosed -eblow "Noo... I don't see it that way, it's just I don't need it! It's rather cumbersome for me."
    her -mhappy "I'm no longer interested in being a one-night stand in a long-term relationship. And my body is getting tired too, I don't feel the need anymore. I've come to accept it and that's okay."
    ...
    her -eblow -eyclosed "*ahem* You got so curious, but so am I now. What about you? You told me you had a crush on a classmate."
    mco "Well, not long ago. You know, I had my graduation party. Though, I confessed my feelings to him just before we left. But he left, embarrassed. He hasn't replied me since."
    her msad "Shoot..."
    mco "I was prepared, I did it before we part ways, so it's not a big problem. I'm used to it now."
    pause 2
    mco "... I feel behind others, I never had a girl or boy friend and so many already did. In my class some were already planning to buy a house with their partner, can you believe that?"
    her ebsad "Oh big guy, don't say harsh things to yourself."
    pause 1
    her eyclosed mnormal "I think you're wonderful and a mature person for your age."
    ...
    mci "Geez, Martin's always the horny one in our calls."
    hero -eblow eyclosed "*AHEM* {color=#9e8b53}{size=29}Rholala can't be serious for 5 minutes{/size}{/color}..."
    ...
    mar "I love snow, but it's so scarce where I am. Like every 2 or 3 years. I'm so excited!"
    hero -eyclosed "Well have fun Martin, I hope it won't be too serious at our altitude."
    pause 2
    define marbf = Character("???", color="#fafafa", kind=calling)
    marbf "{color=#9e8b53}{size=29}My cookie, diner is ready!{/size}{/color}"
    mar "{color=#9e8b53}{size=29}Coming honey!{/size}{/color} Have to go, my maple prepared dinner."
    hero eyclosed mhappy eblow "Have a good meal you two!"
    mco "See ya, have a great night Martin."
    mar "{color=#9e8b53}{size=29}Have a good time in bed guyys~{/size}{/color}"
    ...
    mco "Okay, you got any favorite genres?"
    her eyclosed "I'm really into cartoons these days."
    mco "That's a good contrast with your age." 
    her eyclosed eblow mhappy "It's too late to worry about that, I've always been a child at heart, haha."
    ...
    pause 1
    mco "{color=#9e8b53}{size=29}... Maybe just a hug, I could ask?{/size}{/color}"
    stop sfx1
    ...
    show he at middle with dissolve
    pause 1
    her "I just watched the weather forecast, and we are in a snowstorm for at least two days. We're going to stay nice and warm at home. Don't hesitate to crank up the heat."
    ...
    show he:
        ...
        repeat
    pause 1    
    mci "It's such a madhouse this morning, and Hervé seems all worried due to the snowstorm." 
    her "{color=#9e8b53}{size=29}The electric meter, with all the machines on, it will trip for sure.{/size}{/color}"
    mci "He's grumbling quietly to himself, while walking in circles. He clearly looks sleep-deprived."
    mci "... Whereas, I'm not very well awake either, I don't even know what time it is."
    pause 1
    her "{color=#9e8b53}{size=29}... I have too turn off all the useless heaters and machines...!{/size}{/color}" 
    her ebsad "{color=#9e8b53}{size=29}... Grr, and I'm really hope the boiler will hold the load this time.{/size}{/color}"
    pause 1 
    mco "Hey, hey Hervé *yawn*."
    mco "Take it easy, I'll take care of it for you."
    pause 1
    her -eyclosed "...?"
    show he at middle
    her "Oh sorry [player_name], I forgot to say hello."
    ...
    her "{color=#9e8b53}{size=29}... I haven't slept that well tonight.{/size}{/color}"
    pause 1
    mco "You took care of me the last days, let me take charge of all. I'll make breakfast. Take a rest there on the couch."
    her eyclosed mnormal "{color=#9e8b53}{size=29}Thank you.{/size}{/color}"
    show houseKitchen at tintDimRoom
    hide he
    with Fade(1,1,1)
    $ renpy.music.set_volume(0.5, delay=5, channel='sfx1')
    mco "Mmh mh mh~ 🎶 *whistling*"
    mci "While waiting for the drinks to heat up in the microwave, I stare at the outdoor. It's so dense outside, it's almost like the night in broad day."
    ...
    mci "Probably, he carries too much weight on his shoulders and feels obliged to take care of everything? I haven't realised but from the start, with my car, housing and cooking, he's done a lot already." 
    mci "Maybe I can help him relax, and take more the lead to find activities for the day."
    pause 1
    mci "I put my glass of milk and his tea water to the microwave. Hopefully Hervé doesn't watch me doing breakfast."
    ...
    menu:
        "Continue reading the mail":
            ...
            pause 2
            mci "Gosh, why can't they say directly I'm not qualified?"
            pause 1
    ...
    her "ZzzZzz..."
    pause 2
    mci "...Watching him sleep, I wonder how would I be at his age."
    ...
    mco "Woah... {color=#9e8b53}{size=29}is it me or it's getting windier outside?{/size}{/color}"
    ...
    pause 1
    mco "Young Hervé? What a stud! B-but he's half naked?!"
    mci "Looks like a cut photo... I wonder, where would it come from?"
    mco "Mmmh... A Playboy magazine, who knows... {color=#9e8b53}{size=29}I wonder what Martin could say, for sure he would be salivating.{/size}{/color}"
    pause 2
    mci "He's got the dreamy look. He didn't lose it over the years."
    pause 1
    ...
    mci "On it, this group of friends looks all joyful, and {i}gay{/i}, except Hervé with a quirky smile on it, he seems a little embarrassed."
    pause 2
    mco "And there's a few family photos too..."
    pause 1
    mco "{i}\"Family reunion for mommy\" Amiens, 2018{/i}."
    pause 1
    mci "It's quite the family. Lots of people on it... Hervé's family most likely. They look like in a retirement house. An old bear lady is in the middle, on a wheelchair, surrounded with people of all ages."
    ...
    pause 2
    mco "{color=#9e8b53}{size=29}... I'll put it back, it's none of my business.{/size}{/color}"
    scene black
    ...
    mci "I slipped away the photo frame, it's all dark all of the sudden but I can't move, I'm going to cut myself."
    pause 1
    mco "Hervé?? Hervé!"
    pause 2
    ...
    pause 1
    mci "He's really close to me. With the intense wind outside and this all dark house, I feel relieved I'm with Hervé right now. So much so that I would really like..."
    pause 1
    mco "Hervé... {color=#9e8b53}{size=29}I'd really like to hug with you.{/size}{/color}"
    pause 1
    her eblow eyclosed "O-oh sure. Come here, {color=#9e8b53}{size=29}be careful with the glass.{/size}{/color}"
    show he:
        xalign 0.5
        yalign 0.0
        ease 3 zoom 1.5
    ...
    pause 1
    her eyopen "{color=#9e8b53}{size=29}You feeling better?{/color}{/size}"
    mco "{color=#9e8b53}{size=29}Y-yes.{/color}{/size}"
    her eyclosed "{color=#9e8b53}{size=29}Lemme clean the floor, let's go on the sofa.{/color}{/size}"
    pause 1
    show houseLounge at tint20 
    play sfx1 fireplace
    hide he
    with Fade(1,1,1)
    mci "After the cleaning, we checked the electric meter, but no luck putting it back on. By calling a neighbor, we got informed that it's a general electric breakdown, and they advised us to stay safe home."
    hero ebsad msad "We'll need to be careful with power, I'll shutdown my phone for now."
    pause 1
    mci "He pauses for a moment with a serious look, I can tell he's planning things up, then he looks at me and takes a relaxed face again."
    hero eblow mnormal "{color=#9e8b53}{size=29}Arrh{/color}{/size} *sigh*..."
    hero "... Let's just rest a bit on the couch, come here."
    mci "He taps on the sofa and shows me a spot next to him."
    pause 2
    mci "The place is quite peaceful, I take a look all around me, of this immense house plunged into the dark. With his presence, it feels more reassuring. We are just the two of us, and safe."
    pause 2
    ...
    mci "I slowly put my head on his torso and my hand on his belly, so soft. He's petting me too, really gentle to the touch."
    pause 1
    mco "... Hervé."
    mco "Is it okay with your frame? You're really not upset?"
    hero "No I'm not, it's all fine."
    hero "It's no big deal, it's just a frame."
    pause 1
    mco "There's your mom and your family on it, right?"
    hero msad eyclosed eblow "Mmh-- yeah."
    mco "You seemed gloomy on the photo, this is not the Hervé I know...!"
    hero mhappy eyclosed eblow "Mmmh... Haha."
    hero msad "Mmmh, well... Urrh. To be frank, I've never felt great in my family."
    pause 2
    hero ebsad -eyclosed "I've never been able to find a job... or to be straight... It really excluded me from my family."
    hero ebsad -eyclosed "All of that made me quite shy, and I thought the main issue was my sexuality at the time."
    hero ebnormal "Even though I managed to free myself of it just a bit, and have a couple of friends in Paris, it really helped to know who I was."
    pause 1
    hero "... For short, I was the eldest brother at home late and jobless, my parents weren't too kind with me. It was the hardest times in my life, like roller coasters."
    pause 1 
    hero -eblow "And after a while I just left home! I've had enough! It was the point of no return, but I just... Needed that!" 
    hero mnormal "... I... Took my car, to the countryside. With very little money, and no idea for a job."
    hero "Until I stumbled upon this valley."
    hero eyclosed mhappy eblow "And quite some time after, I even got my own little house!"
    pause 2
    hero -mhappy "... My family, I recontacted them at some point. I tried to come see mom once in a while, but the mood is so chilly. And I can't find the strengh to speak to them. *chuckles* There's an immense snowstorm between us."
    ...
    mco "... That sounds so tough Hervé."
    pause 1
    hero mhappy "... That's why I prefer to focus on friends."
    pause 2
    hero msad "To a large extent, this is my fault. But there's nothing to be done with my family, that's way too late."
    mco "O-okay, I see."
    pause 2
    mci "I remember yesterday... My good friend, Martin's catchphrase..."
    pause 2
    ...
    if affinity > 2:
        ...
        menu:
            "Continue hugging":
                ...
                hero msad "..."
                pause 1
                hero msad "*long sigh* My. god. You're making me feel like a geezer right now."
                pause 2
                mci "I'm starting to make circles around his belly, I want to say many things to him, this is a really a good moment..."
                mco "I want to be frank with you Hervé..."
                mco "Since we exchanged online, you really are a great friend to me. Maybe my best friend."
                ...
                mco "But I knew it would be weird probably, I'm not even sure how my family would react. In the end, I preferred to not cross the line, and finding someone my age."
                mco "Although, now..."
                pause 2
                mco "... I feel it would be possible for me to love you."
                hero -eyclosed -eblow mnormal "Woah there hehe..."
                pause 1
                ...
                pause 2
                hero "... I think for sure, it would take time for me..."
                pause 1
                hero mnormal -eblow "But I'm into you too."
                mco "Awww??"
                mci "I do my biggest puppy dog eyes to him."
                hero mhappy "But please, I would need time. I know you're young and all..."
                mco "Sure!!"
                pause 2
                mco "{color=#9e8b53}{size=29}Could we sleep together this night?{/color}{/size}"
    ...
    mco "I don't know, but with you telling me your life, it kinda reminded me of a papa bear telling me some stories."
    hero ebeto -eyclosed "Ruff-- Papa? Bear?"
    mco "*chuckles*"
    hero eblow eyclosed "*sigh*, well why not. What's on your mind, some sort of roleplay?"
    mco "Yeah! I'm a pro at it! Lemme begin."
    pause 2
    mco "We're together in a strange forest... {color=#9e8b53}{size=29}I'm a great mage and you're...{/color}{/size}"
    pause 1
    stop sfx1 fadeout 5
    ...
    if affinity > 2:
        ...
        her "{color=#9e8b53}{size=29}... H-hi Madam!{/color}{/size}"
        pause 2
        show photo1
        ...
        pause 2
        mcc "Mhm yeah, time goes fast... It's been nearly a year now, woah. I've seen all the seasons, it's been so great, I'm glad living here."
        pause 2
        show photo2
        mcc "I'll show you the hiking, the little villages. And the food!"
        mcc "{color=#9e8b53}{size=29}Hey, Hervé also wants to make the best impression for you, as always-- He's all tense for real...{/color}{/size}"
        her "{color=#9e8b53}{size=29}H-hey, honey...!{/color}{/size}"
        her "Sorry Madam, he's saying nonsense..."
        her "[player_name] is a real naughty boy, for sure Santa Claus won't come for him this Christmas... I don't know if he will deserve his present..."
        pause 2
        mcc "Heyy? What? What are you two up to, there's a gift for me? "
        her "You'll know on December the 25th!"
        mcc "..."
        ...
        pause 2
        show photo11
        mcc "Me, I'm still on the west coast. It's quite busy at work with the holidays."
        mcc "{i}When do I come home...{/i}? ... Probably for Christmas."
        pause 2
        mcc "I know, sorry. I don't have much vacations..."
        pause 5
        show photo12
        mci "I'll always remember my last holidays in my home country."
        mci "That was with you and you were the first gay I met. Now I'm doing my own life, but you really helped me when I was younger."
        mci "I feel more open now with who I am, and I try dating too. But it's hard in a way, it's not always easy to connect with the locals."
        mci "Not the same connection like you or the people of my country. I'm probably am homesick, ahah."
        pause 2
        show photo13
        mci "I left quite everything, like you did... Hervé."
        mci "And, since then, I feel I'm going apart from you, my family and the friends I had."
        mci "It's been a couple months we didn't contact each other. I hope I could see you again, like for holidays but it's difficult."
        mci "Time and money flies away..."
        pause 2
        mcc "--Well see ya mom. I gotta go."
        mcc "Take care."
        pause 1
        scene black with Dissolve(5)
    return
