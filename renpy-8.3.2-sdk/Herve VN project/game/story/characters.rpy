...
label characters:
    ...
    define her = Character("Hervé", color="#d9bb91", image="he", kind=outter, callback = name_callback, cb_name = "he") # character
    define mco = Character("[player_name]", color="#696fd4", image="mcSide", kind=outter, callback = name_callback, cb_name = "mc")
    define mci = Character("[player_name]", color="#696fd4", kind=inner)
    define mct = Character("[player_name]", color="#696fd4", kind=texting)
    define hert = Character("Hervé", color="#d9bb91", kind=texting)
    define hero = Character("Hervé", color="#d9bb91", image="heSide", kind=outter, callback = name_callback, cb_name = "he") # character
    define momt = Character("Mom", color="#cdb0f3", kind=texting)
    define momt = Character("Mom", color="#cdb0f3", kind=texting)
    define mar = Character("Martin", color="#b3a48a", kind=calling)
